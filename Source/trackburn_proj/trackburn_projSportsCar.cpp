...
#include "trackburn_projSportsCar.h"
#include "trackburn_projSportsWheelFront.h"
#include "trackburn_projSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

Atrackburn_projSportsCar::Atrackburn_projSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Utrackburn_projSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Utrackburn_projSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Utrackburn_projSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Utrackburn_projSportsWheelRear::StaticClass();
