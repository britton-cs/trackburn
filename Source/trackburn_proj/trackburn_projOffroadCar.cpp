...
#include "trackburn_projOffroadCar.h"
#include "trackburn_projOffroadWheelFront.h"
#include "trackburn_projOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

Atrackburn_projOffroadCar::Atrackburn_projOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = Utrackburn_projOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = Utrackburn_projOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = Utrackburn_projOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = Utrackburn_projOffroadWheelRear::StaticClass();
